...
io.on('connection', function (socket) {
    ...
    socket.on('createGame', function (data) {
        games.push({ gameId: data.gameId, gameName: data.gameName, gameMode: data.gameMode, playerList: [socket.id], teams: [], started: false, team1Question: -1, team2Question: -1, team1Answer: -1, team2Answer: -1 });
